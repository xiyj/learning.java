...
public class LoopBackTimeStamp {
	...
	public String toString() {
		return "LoopBackTimeStamp [sendTimeStamp=" + sendTimeStamp + ", recvTimeStamp=" + recvTimeStamp + "]";
	}
	...
	/**
	 * Transfer 2 long number to a 16 byte-long byte[], every 8 bytes represent a
	 * long number.
	 * 
	 * @return
	 */
